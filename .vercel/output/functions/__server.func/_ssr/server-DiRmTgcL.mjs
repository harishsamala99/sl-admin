...
import { i as defineHandlerCallback, G as resolveManifestAssetLink, H as rootRouteId, o as getNormalizedURL, p as getOrigin, b as attachRouterServerSsrUtils, f as createSerializationAdapter, e as createRawStreamRPCPlugin, t as invariant, x as isNotFound, y as isRedirect, z as isResolvedRedirect, D as mergeHeaders, l as executeRewriteInput, h as defaultSerovalPlugins, C as makeSerovalPlugin, r as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bi9gw-1O.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-msbZomiZ.mjs").then((n) => n.r),
    import("./start-wvh_o--K.mjs"),
